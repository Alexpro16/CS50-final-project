...
const extended = document.getElementById('extended-menu');
...
function showMovies(data) {
    ...
    data.forEach(movie => {
        const {title, poster_path, vote_average, overview, id, realese_date, vote_count, original_language} = movie;
        ...
        <div class="container">
          <div id="con_1">
            <ul id="film-info">
              ...
              <li>Overview: <br>${movie.overview}</li>
            </ul>
          </div>
          <div id="con_2"></div>
          <div id="con_3">
